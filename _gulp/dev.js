...
gulp.task('watch:dev', () => {
    ...
    gulp.watch('./src/assets/img/**/*', gulp.parallel('copy-img:dev'));
    gulp.watch('./src/assets/fonts/**/*', gulp.parallel('copy-fonts:dev'));
    gulp.watch('./src/js/**/*.js', gulp.parallel('js:dev'));
});

gulp.task('build:dev', gulp.parallel('copy-fonts:dev', 'html:dev', 'sass:dev', 'copy-img:dev', 'js:dev', 'copy-favicon:dev'));
